...
```
More examples [can be found there](https://bucket4j.github.io/8.16.0/toc.html#quick-start-examples)

## [Documentation](https://bucket4j.github.io)
* [Reference](https://bucket4j.github.io/8.16.0/toc.html)
* [Quick start examples](https://bucket4j.github.io/8.16.0/toc.html#quick-start-examples)
...
| :---                       | :---:            |:-----------------------------:|:-----------------------:|:-------------------:|:-------------------------------------------------------------------------------------:|
| ```JCache API (JSR 107)``` |  No              |              No               |          No             |         No          |     [bucket4j-jcache](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-jcache)     |
| ```Hazelcast```            |  Yes             |              Yes              |           Yes           |         No          |  [bucket4j-hazelcast](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-hazelcast)  |
| ```Apache Ignite```        |  Yes             |              No               |           n/a           |         Yes         |     [bucket4j-ignite](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-ignite)     |
| ```Inifinispan```          |  Yes             |              Yes              |           Yes           |         No          | [bucket4j-infinispan](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-infinispan) |
| ```Oracle Coherence```     |  Yes             |              Yes              |           Yes           |         No          |  [bucket4j-coherence](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-coherence)  |

### Redis back-ends
| Back-end                   |  Async supported | Redis cluster supported |                                       Documentation link                                       |
| :---                       | :---:            |:-----------------------:|:----------------------------------------------------------------------------------------------:|
| ```Redis/Redisson```       |  Yes             |           Yes           |    [bucket4j-redis/Redisson](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-redisson)     |
| ```Redis/Jedis```          |  No              |           Yes           |  [bucket4j-redis/Jedis](https://bucket4j.github.io/8.16.0/toc.html#toc.html#bucket4j-jedis)    |
| ```Redis/Lettuce```        |  Yes             |           Yes           | [bucket4j-redis/Lettuce](https://bucket4j.github.io/8.16.0/toc.html#toc.html#bucket4j-lettuce) |

### Valkey back-ends
| Back-end                   |  Async supported | Redis cluster supported |                                       Documentation link                                       |
| ```Valkey/Glide```         |  Yes             |           Yes           | [bucket4j-valkey/Glide](https://bucket4j.github.io/8.16.0/toc.html#toc.html#bucket4j-glide) |


### Mongo back-ends
| Back-end                      | Async supported |                                          Documentation link                                          |
|:------------------------------|:---------------:|:----------------------------------------------------------------------------------------------------:|
| ```Mongodb/mongodb-driver-sync```            |       No        |      [bucket4j-mongodb/sync](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-mongodb-sync)       |
| ```Mongodb/mongodb-driver-reactivestreams``` |       Yes       | [bucket4j-mongodb/async](https://bucket4j.github.io/8.16.0/toc.html#toc.html#bucket4j-mongodb-async) |

### JDBC back-ends
| Back-end                   |                                  Documentation link                                   |
|:---------------------------|:-------------------------------------------------------------------------------------:|
| ```MySQL```                |      [bucket4j-mysql](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-mysql)      |
| ```PostgreSQL```           | [bucket4j-postgresql](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-postgresql) |
| ```Oracle```               |     [bucket4j-oracle](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-oracle)     |
| ```Microsoft SQL Server``` |      [bucket4j-mssql](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-mssql)      |
| ```MariaDB```              |    [bucket4j-mariadb](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-mariadb)    |
| ```DB2```                  |        [bucket4j-db2](https://bucket4j.github.io/8.16.0/toc.html#bucket4j-db2)        |
