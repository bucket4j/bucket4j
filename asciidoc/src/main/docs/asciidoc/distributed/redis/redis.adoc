...
|===
IMPORTANT: For all libraries mentioned above, concurrent access to Redis is handled via the Compare&Swap pattern; this could be improved in the future by switching to Lua stored procedures.
