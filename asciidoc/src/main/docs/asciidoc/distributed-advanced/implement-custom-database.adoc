...
and override 3 methods and create your implementation which implements `io.github.bucket4j.distributed.proxy.generic.select_for_update.LockBasedTransaction`.
