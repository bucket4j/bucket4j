...
module.exports = function (config) {
  config.set({
    ...
    files: [
      ...
      { pattern: 'src/bucket4j/**/*.ts', watched: true, served: true, included: true }
      /*parameters:
    ...
    reporters: ['mocha', 'kjhtml', "progress", "karma-typescript"/*,'dots','progress','spec'*/],
    ...
    preprocessors: {
      //add webpack as preprocessor to support require() in test-suites .js/.ts files
      //'./src/test/**/*.spec.ts': ['webpack', 'sourcemap', 'karma-typescript'],
