...
public class CreateSnapshotCommand implements RemoteCommand<RemoteBucketState>, ComparableByContent<CreateSnapshotCommand> {
    ...
    public static final SerializationHandle<CreateSnapshotCommand> SERIALIZATION_HANDLE = new SerializationHandle<>() {
        @Override
        ...
        @Override
        public int estimateSize(CreateSnapshotCommand command, Version backwardCompatibilityVersion, Scope scope) {
        ...
        @Override
        public CreateSnapshotCommand fromJsonCompatibleSnapshot(Map<String, Object> snapshot) {
        ...
        @Override
        public Map<String, Object> toJsonCompatibleSnapshot(CreateSnapshotCommand command, Version backwardCompatibilityVersion, Scope scope) {
