 ...
 *
 * <p>
 * This interface is actual only if an optimization was applied during bucket construction via {@link RemoteAsyncBucketBuilder#withOptimization(BucketSynchronization)}
 * otherwise all methods of controller will do nothing.
 */
public interface AsyncBucketOptimizationController {
