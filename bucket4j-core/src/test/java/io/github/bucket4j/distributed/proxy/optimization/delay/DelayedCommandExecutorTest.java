...
@DisplayName("DelayedCommandExecutor Specification")
class DelayedCommandExecutorTest {
    ...
    void shouldDelaySyncConsumption() throws Exception {
        ...
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(99);
        ...
        // token was consumed
        assertThat(consumed).isTrue();
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(98);
        ...
        // token was consumed
        assertThat(consumed).isTrue();
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(98); // one token was refilled
        ...
        // token was consumed
        assertThat(consumed).isTrue();
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(79);
        ...
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(78);
        assertThat(optimizedBucket.tryConsumeAsMuchAsPossible(15)).isEqualTo(15);
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(63);

        // 500 millis passed
        clock.addMillis(500); // 500
        // request not propogated to proxyManager
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(100);
        assertThat(notOptimizedBucket.getAvailableTokens()).isEqualTo(50);

        // 1 millis passed
        clock.addMillis(1); // 501
        // request propogated to proxyManager
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(34);
    ...
    void testSynchronizationByConditionalRequirement() throws Exception {
        ...
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(90);
        assertThat(notOptimizedBucket.getAvailableTokens()).isEqualTo(100);
        ...
        // synchronization have not performed
        assertThat(optimizedBucket.getAvailableTokens()).isEqualTo(80);
        assertThat(notOptimizedBucket.getAvailableTokens()).isEqualTo(90);
