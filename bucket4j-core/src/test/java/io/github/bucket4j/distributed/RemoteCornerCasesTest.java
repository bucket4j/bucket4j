...
class RemoteCornerCasesTest {

    @Test
    void shouldCompleteFutureExceptionallyIfProxyManagerFailed() throws Exception {
        // setup:
        ProxyManagerMock<String> proxyManagerMock = new ProxyManagerMock<>(SYSTEM_MILLISECONDS);
