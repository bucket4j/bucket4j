...
class PredictiveAsyncCommandExecutorTest {
    ...
    void shouldDelaySyncConsumption() throws Exception {
        ...
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(99L);
        ...
        // then: token was consumed
        assertThat(consumed).isTrue();
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(98L);
        ...
        // then: token was consumed
        assertThat(consumed).isTrue();
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(98L); // one token was refilled
        ...
        // then: token was consumed
        assertThat(consumed).isTrue();
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(79L);
        ...
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(78L);
        assertThat(optimizedBucket.tryConsumeAsMuchAsPossible(15).get()).isEqualTo(15L);
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(63L);
        ...
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(38L);
        ...
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(28L);

        // when: 125 millis passed
        clock.addMillis(125);
        // then: optimized bucket takes care about other nodes consumption rate
        assertThat(notOptimizedBucket.getAvailableTokens()).isEqualTo(75L);
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(22L);
        ...
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(3L);
        ...
        // then:
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(-15L);
        assertThat(notOptimizedBucket.getAvailableTokens()).isEqualTo(-15L);

        // when:
        clock.addMillis(100);
        // then:
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(-5L);
        assertThat(notOptimizedBucket.getAvailableTokens()).isEqualTo(-5L);

        // when:
        clock.addMillis(50);
        // then:
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(0L);
        assertThat(notOptimizedBucket.getAvailableTokens()).isEqualTo(0L);
        ...
        clock.addMillis(400);
        // then:
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(50L);
    ...
    void testSynchronizationByConditionalRequirement() throws Exception {
        ...
        // then:
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(90L);
        assertThat(notOptimizedBucket.getAvailableTokens()).isEqualTo(100L);
        ...
        // then: synchronization have not performed
        assertThat(optimizedBucket.getAvailableTokens().get()).isEqualTo(80L);
        assertThat(notOptimizedBucket.getAvailableTokens()).isEqualTo(90L);
