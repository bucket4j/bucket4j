...
public class IgniteWithBackgroundExecutorAndTimeoutTest extends AbstractDistributedBucketTest<String> {
    ...
    protected ProxyManager<String> getProxyManager() {
        ExecutionStrategy executionStrategy = ExecutionStrategy.backgroundTimeBounded(Executors.newFixedThreadPool(20), Duration.ofSeconds(5));
        return new IgniteProxyManager<>(cache, ClientSideConfig.getDefault().withExecutionStrategy(executionStrategy));
    }
