...
public class CoherenceWithJdkSerializationTest extends AbstractDistributedBucketTest {
    ...
    private static final int WKA_PORT = 9785;
    private static final int CLIENT_PORT = 9786;
    ...
    private static void configureCoherence(int localPort, int wkaPort, boolean storageEnabled) {
        System.setProperty("coherence.cluster", "bucket4j-coherence-21-jdk-test");
        ...
        System.setProperty("coherence.cacheconfig", "test-coherence-jdk_serialization-config.xml");
    }
