...
import io.github.bucket4j.grid.infinispan.Bucket4jInfinispan.InfinispanAsyncProxyManagerBuilder;
 ...
 */
public class InfinispanAsyncProxyManager<K> extends AbstractAsyncProxyManager<K> {
    ...
    InfinispanAsyncProxyManager(InfinispanAsyncProxyManagerBuilder<K> builder) {
